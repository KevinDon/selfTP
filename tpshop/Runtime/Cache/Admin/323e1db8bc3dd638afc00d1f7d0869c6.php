...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo (CSS_URL); ?>/css/User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="<?php echo ROOT ?>/index.php/Admin/index" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img width="100"  src="<?php echo ROOT ?>/index.php/Admin/Login/verify"  alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('<?php echo (IMG_URL); ?>/img/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
