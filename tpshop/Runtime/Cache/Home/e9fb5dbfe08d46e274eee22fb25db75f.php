...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="{$Think.CSS_URL}css/style.css" rel="stylesheet" type="text/css" />

    </head>
    <body>
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top">
                <img class="logo" src="{$Think.IMG_URL}images/logo.gif">
            </a>
            ...
            <div id="bottomNav" class="box block">
                <div class="box_1">
                    <div class="links clearfix"> 
                        <a href="#" target="_blank" title="YONGDA商城"><img src="{$Think.IMG_URL}images/logo.gif" alt="YONGDA商城" border="0"></a>
